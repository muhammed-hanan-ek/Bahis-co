...
export class BACService {
  ...
  LoadMenu(): Observable<any> {
    return this.http.post(`${ApiUrl}/user/loadMenu`, {});
  }
  ...
  LoadUserList(): Observable<any> {
    return this.http.post(`${ApiUrl}/user/list`, {});
  }
  ...
  LoadEditUSer(UserId: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/user/Load`, formData);
  }
  DeleteUser(UserId: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/user/Delete`, formData);
  }
  ...
  addUser(
    ...
    return this.http.post(`${ApiUrl}/user/add`, formData);
  }
  ...
  addWork(
    ...
    return this.http.post(`${ApiUrl}/work/add`, formData);
  }
  ...
  LoadEditWork(slno: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/work/load`, formData);
  }
  ...
  DeleteWork(workId: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/work/Delete`, formData);
  }
  ...
  ApproveOrRejectWork(
    ...
    return this.http.post(`${ApiUrl}/work/ApproveOrReject`, formData);
  }
  ...
  LoadAd(slno: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/ad/load`, formData);
  }
  LoadConvesrion(slno: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/sales/load`, formData);
  }
  ...
  SaveAd(
    ...
    return this.http.post(`${ApiUrl}/ad/add`, formData);
  }
  ...
  DeleteAD(SLNO: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/ad/Delete`, formData);
  }
  ...
  SaveConversion(SLNO: any, AD: any, count: any, amount: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/sales/add`, formData);
  }
  ...
  viewad(slno: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/sales/List`, formData);
  }
  conversionPdf(slno: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/sales/pdf`, formData);
  }
  conversionexcel(slno: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/sales/excel`, formData);
  }
  ...
  Deleteconversion(slno: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/sales/Delete`, formData);
  }

  loadAdminDashboard(): Observable<any> {
    return this.http.post(`${ApiUrl}/AdminDashboard`, {});
  }
  loadClientDashboard(): Observable<any> {
    return this.http.post(`${ApiUrl}/ClientDashboard`, {});
  }
  loadStaffDashboard(): Observable<any> {
    return this.http.post(`${ApiUrl}/StaffDashboard`, {});
  }
  loadNotification(): Observable<any> {
    return this.http.post(`${ApiUrl}/user/notifications`, {});
  }
  ...
  notificationMarkAsRead(type: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/user/notificationMarkAsRead`, formData);
  }
  notificationMarkALLAsRead(): Observable<any> {
    const formData = new FormData();

    return this.http.post(`${ApiUrl}/user/notificationMarkALLAsRead`, formData);
  }
  ...
  LoadcreateEditWorkCalendar(slno: any): Observable<any> {
    ...
    return this.http.post(`${ApiUrl}/work_calendar/load`, formData);
  }
  ...
  addWorkCalendar(
    ...
    return this.http.post(`${ApiUrl}/work_calendar/add`, formData);
  }
