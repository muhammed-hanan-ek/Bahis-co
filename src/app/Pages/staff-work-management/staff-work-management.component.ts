...
handleOutsideClick(event: any) {
  ...
  works: Work[] = [
    { title: 'Website UI Design', client: 'ABC Company', month: '2024-06', status: 'Pending' },
    { title: 'API Integration', client: 'TechCorp', month: '2024-06', status: 'Approved' },
    { title: 'Mobile Bug Fix', client: 'Global Solutions', month: '2024-06', status: 'Rejected' },
    { title: 'Mobile Bug Fix', client: 'Global Solutions', month: '2024-06', status: 'Rejected' },
    { title: 'Website UI Design', client: 'ABC Company', month: '2024-06', status: 'Pending' },
    { title: 'API Integration', client: 'TechCorp', month: '2024-06', status: 'Approved' },
    { title: 'Mobile Bug Fix', client: 'Global Solutions', month: '2024-06', status: 'Rejected' },
